...
public class ChessBoard {
    ...
    public static int DEBUGFOCUS_SQ = coordinateString2Pos("d3");   // changeable globally, just for debug output and breakpoints+watches
    public static int DEBUGFOCUS_VP = 26;   // changeable globally, just for debug output and breakpoints+watches
